...
import static org.jedauret.todolist.web.rest.TestUtil.sameInstant;
import static org.jedauret.todolist.web.rest.TestUtil.createFormattingConversionService;
...
public class TaskResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_DUE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
     ...
     *
     * @see org.jedauret.todolist.repository.search.TaskSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllTasks() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].due").value(hasItem(sameInstant(DEFAULT_DUE))))
    ...
    public void getTask() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks/{id}", task.getId()))
            ...
            .andExpect(jsonPath("$.due").value(sameInstant(DEFAULT_DUE)))
